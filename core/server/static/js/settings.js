const SETTINGS_PAGES = {
  general: {
    ...
    render: () => grid([
      ...
      card('💡', 'Helpful links', 'Quick access to QuizMaster resources while setup documentation is expanded.', actionRow([
        button('Open quizmaster.online', () => openExternal(localBaseUrl())),
        button('Open widgets.quizmaster.online', () => openExternal(localBaseUrl()), 'secondary'),
      ])),
    ])
  },
  accounts: {
  ...
  about: {
    ...
    render: () => grid([
      ...
      card('🌐', 'Links', 'Open official QuizMaster web destinations and support resources.', actionRow([button('Open quizmaster.online', () => openExternal(localBaseUrl())), button('Open widgets.quizmaster.online', () => openExternal(localBaseUrl()), 'secondary'), button('Open support page', () => placeholder('Open support page'), 'secondary')]), 'wide'),
